...
<head>
  ...
  <script src="http://localhost/hdtentv5/assets/js/jquery-ui-1.10.4.custom.js"></script>
  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="assets/images/logo.png" class="m-r-sm">Notebook</a>
